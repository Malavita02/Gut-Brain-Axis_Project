...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='E:\\UMinho\\Projeto MRI\\stress_reward\\stress_food_reward_lastrun.py',
...
instructions = visual.TextStim(win=win, name='instructions',
    text='Instruções\n\nNesta tarefa, terá de selecionar 1 imagem entre 3 pares de imagens que serão apresentados. Após a sua escolha, poderá receber 0,75 mL de sumo, solução de sabor neutro ou nada.\n\nCarregue na tecla "espaço" para iniciar.',
    font='Open Sans',
...
text_8 = visual.TextStim(win=win, name='text_8',
    ...
    languageStyle='LTR',
    depth=-2.0);
Response_t = keyboard.Keyboard()

activate_pump(Response_t)

# --- Initialize components for Routine "feedback_tomato" ---
...
stim_image_t1_2 = visual.ImageStim(
    win=win,
    name='stim_image_t1_2', units='height', 
    image='sin', mask=None, anchor='center',
    ori=0.0, pos=[0,0], size=(0.3, 0.3),
    color='white', colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-2.0)
stim_image_t2_2 = visual.ImageStim(
    win=win,
    name='stim_image_t2_2', 
    image='sin', mask=None, anchor='center',
    ori=0.0, pos=[0,0], size=(0.3, 0.3),
    color='white', colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
text_9 = visual.TextStim(win=win, name='text_9',
    ...
    languageStyle='LTR',
    depth=-2.0);
Response_n = keyboard.Keyboard()

activate_pump(Response_n)
...
text_14 = visual.TextStim(win=win, name='text_14',
    ...
    languageStyle='LTR',
    depth=0.0);
stim_image_n1_2 = visual.ImageStim(
    win=win,
    name='stim_image_n1_2', units='height', 
    image='sin', mask=None, anchor='center',
    ori=0.0, pos=[0,0], size=(0.3, 0.3),
    color='white', colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-1.0)
stim_image_n2_2 = visual.ImageStim(
    win=win,
    name='stim_image_n2_2', units='height', 
    image='sin', mask=None, anchor='center',
    ori=0.0, pos=[0,0], size=(0.3, 0.3),
    color='white', colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
welcomeComponents = [instructions, key_resp]
...
for thisSeq_condition in seq_conditions:
    ...
    for thisChoco in choco:
        ...
        while continueRoutine and routineTimer.getTime() < 1.5:
            ...
            if stim_image_c1.status == STARTED:  # only update if drawing
                stim_image_c1.setPos((X_c1, Y_c1), log=False)
            ...
            if stim_image_c2.status == STARTED:  # only update if drawing
                stim_image_c2.setPos((X_c2, Y_c2), log=False)
            ...
            if Response_c.status == STARTED and not waitOnFlip:
                theseKeys = Response_c.getKeys(keyList=['1','2','3','4'], waitRelease=False)
            ...
            resp_c = Response_c.getKeys(['1','2','3','4'], waitRelease=False, clear=False)
        ...
        routineForceEnded = False
        # update component parameters for each repeat
        stim_image_c1_2.setColor([1,1,1], colorSpace='rgb')
        ...
        while continueRoutine and routineTimer.getTime() < 4.0:
            ...
            if stim_image_c2_2.status == STARTED:  # only update if drawing
                stim_image_c2_2.setColor([1,1,1], colorSpace='rgb', log=False)
                stim_image_c2_2.setOpacity(None, log=False)
                stim_image_c2_2.setContrast(None, log=False)
            # Run 'Each Frame' code from code
            stim_image_c1_2.setContrast(contrast1)
            stim_image_c2_2.setContrast(contrast2)
            
            #Consider the following responses/image positions:
            # 1 - left up
            # 2 - left down
            # 3 - righ up
            # 4 - right down
            
            #if participant choses image 1 (according to its position)
            if resp_c == '1' and X_c1 == -0.3 and Y_c1 == 0.3:
                contrast1 = -0.5
                contrast2 = 1.0
            elif resp_c == '2' and X_c1 == -0.3 and Y_c1 == -0.3:
                contrast1 = -0.5
                contrast2 = 1.0
            elif resp_c == '3' and X_c1 == 0.3 and Y_c1 == 0.3:
                contrast1 = -0.5
                contrast2 = 1.0
            elif resp_c == '4' and X_c1 == 0.3 and Y_c1 == -0.3:
                contrast1 = -0.5
                contrast2 = 1.0
            #if participant choses image 2 (according to its position)
            elif resp_c == '1' and X_c2 == -0.3 and Y_c2 == 0.3:
                contrast1 = 1.0
                contrast2 = -0.5
            elif resp_c == '2' and X_c2 == -0.3 and Y_c2 == -0.3:
                contrast1 = 1.0
                contrast2 = -0.5
            elif resp_c == '3' and X_c2 == 0.3 and Y_c2 == 0.3:
                contrast1 = 1.0
                contrast2 = -0.5
            elif resp_c == '4' and X_c2 == 0.3 and Y_c2 == -0.3:
                contrast1 = 1.0
                contrast2 = -0.5
            else:
                contrast1 = 1.0
        ...
        # update component parameters for each repeat
        # keep track of which components have finished
        reward_chocoComponents = [fix_reward]
    ...
    for thisTomato in tomato:
        ...
        routineForceEnded = False
        # update component parameters for each repeat
        stim_image_t1.setPos((X_t1, Y_t1))
        stim_image_t1.setImage(image_t1)
        stim_image_t2.setPos((X_t2, Y_t2))
        stim_image_t2.setImage(image_t2)
        Response_t.keys = []
        Response_t.rt = []
        _Response_t_allKeys = []
        # keep track of which components have finished
        stim_tomatoComponents = [stim_image_t1, stim_image_t2, text_8, Response_t]
        ...
        while continueRoutine and routineTimer.getTime() < 1.5:
            ...
            # *Response_t* updates
            waitOnFlip = False
            if Response_t.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                Response_t.frameNStart = frameN  # exact frame index
                Response_t.tStart = t  # local t and not account for scr refresh
                Response_t.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(Response_t, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'Response_t.started')
                Response_t.status = STARTED
                # keyboard checking is just starting
                waitOnFlip = True
                win.callOnFlip(Response_t.clock.reset)  # t=0 on next screen flip
                win.callOnFlip(Response_t.clearEvents, eventType='keyboard')  # clear events on next screen flip
            if Response_t.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > Response_t.tStartRefresh + 1.5-frameTolerance:
                    # keep track of stop time/frame for later
                    Response_t.tStop = t  # not accounting for scr refresh
                    Response_t.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'Response_t.stopped')
                    Response_t.status = FINISHED
            if Response_t.status == STARTED and not waitOnFlip:
                theseKeys = Response_t.getKeys(keyList=['1','2'], waitRelease=False)
                _Response_t_allKeys.extend(theseKeys)
                if len(_Response_t_allKeys):
                    Response_t.keys = _Response_t_allKeys[-1].name  # just the last key pressed
                    Response_t.rt = _Response_t_allKeys[-1].rt
                    # a response ends the routine
                    continueRoutine = False
            # Run 'Each Frame' code from code_3
            resp_t = Response_t.getKeys(['1', '2'], waitRelease=False, clear=False)
        ...
        for thisComponent in stim_tomatoComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        # check responses
        if Response_t.keys in ['', [], None]:  # No response was made
            Response_t.keys = None
        tomato.addData('Response_t.keys',Response_t.keys)
        if Response_t.keys != None:  # we had a response
            tomato.addData('Response_t.rt', Response_t.rt)
        ...
        # --- Prepare to start Routine "feedback_tomato" ---
        continueRoutine = True
        routineForceEnded = False
        # update component parameters for each repeat
        stim_image_t1_2.setColor([1,1,1], colorSpace='rgb')
        stim_image_t1_2.setOpacity(None)
        stim_image_t1_2.setContrast(None)
        stim_image_t1_2.setPos((X_t1, Y_t1))
        stim_image_t1_2.setImage(image_t1)
        stim_image_t2_2.setColor([1,1,1], colorSpace='rgb')
        stim_image_t2_2.setContrast(1.0)
        stim_image_t2_2.setPos((X_t2, Y_t2))
        stim_image_t2_2.setImage(image_t2)
        # keep track of which components have finished
        feedback_tomatoComponents = [text_13, stim_image_t1_2, stim_image_t2_2]
        for thisComponent in feedback_tomatoComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        while continueRoutine and routineTimer.getTime() < 4.0:
            ...
            stim_image_t1_2.setContrast(contrast1)
            stim_image_t2_2.setContrast(contrast2)
            ...
            #if participant choses image 1 (according to its position)
            if resp_t == '1' and X_t1 == -0.3 and Y_t1 == 0.3:
                contrast1 = -0.5
                contrast2 = 1.0
            elif resp_t == '2' and X_t1 == -0.3 and Y_t1 == -0.3:
                contrast1 = -0.5
                contrast2 = 1.0
            elif resp_t == '3' and X_t1 == 0.3 and Y_t1 == 0.3:
                contrast1 = -0.5
                contrast2 = 1.0
            elif resp_t == '4' and X_t1 == 0.3 and Y_t1 == -0.3:
                contrast1 = -0.5
                contrast2 = 1.0
            #if participant choses image 2 (according to its position)
            elif resp_t == '1' and X_t2 == -0.3 and Y_t2 == 0.3:
                contrast1 = 1.0
                contrast2 = -0.5
            elif resp_t == '2' and X_t2 == -0.3 and Y_t2 == -0.3:
                contrast1 = -0.5
                contrast2 = 1.0
            elif resp_t == '3' and X_t2 == 0.3 and Y_t2 == 0.3:
                contrast1 = -0.5
                contrast2 = 1.0
            elif resp_t == '4' and X_t2 == 0.3 and Y_t2 == -0.3:
                contrast1 = -0.5
                contrast2 = 1.0
            else:
                contrast1 = 1.0
            ...
            # *stim_image_t1_2* updates
            if stim_image_t1_2.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                # keep track of start time/frame for later
                stim_image_t1_2.frameNStart = frameN  # exact frame index
                stim_image_t1_2.tStart = t  # local t and not account for scr refresh
                stim_image_t1_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(stim_image_t1_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'stim_image_t1_2.started')
                stim_image_t1_2.setAutoDraw(True)
            if stim_image_t1_2.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > stim_image_t1_2.tStartRefresh + 4.0-frameTolerance:
                    # keep track of stop time/frame for later
                    stim_image_t1_2.tStop = t  # not accounting for scr refresh
                    stim_image_t1_2.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'stim_image_t1_2.stopped')
                    stim_image_t1_2.setAutoDraw(False)
            
            # *stim_image_t2_2* updates
            if stim_image_t2_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                stim_image_t2_2.frameNStart = frameN  # exact frame index
                stim_image_t2_2.tStart = t  # local t and not account for scr refresh
                stim_image_t2_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(stim_image_t2_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'stim_image_t2_2.started')
                stim_image_t2_2.setAutoDraw(True)
            if stim_image_t2_2.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > stim_image_t2_2.tStartRefresh + 4.0-frameTolerance:
                    # keep track of stop time/frame for later
                    stim_image_t2_2.tStop = t  # not accounting for scr refresh
                    stim_image_t2_2.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'stim_image_t2_2.stopped')
                    stim_image_t2_2.setAutoDraw(False)
        ...
        # --- Ending Routine "feedback_tomato" ---
        for thisComponent in feedback_tomatoComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        ...
        # update component parameters for each repeat
        # keep track of which components have finished
        reward_tomatoComponents = [fix_reward_t]
    ...
    for thisNeutral in neutral:
        ...
        routineForceEnded = False
        # update component parameters for each repeat
        stim_image_n1.setPos((X_n1, Y_n1))
        stim_image_n1.setImage(image_n1)
        stim_image_n2.setPos((X_n2, Y_n2))
        stim_image_n2.setImage(image_n2)
        Response_n.keys = []
        Response_n.rt = []
        _Response_n_allKeys = []
        # keep track of which components have finished
        stim_neutralComponents = [stim_image_n1, stim_image_n2, text_9, Response_n]
        ...
        while continueRoutine and routineTimer.getTime() < 1.5:
            ...
            # *Response_n* updates
            waitOnFlip = False
            if Response_n.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                Response_n.frameNStart = frameN  # exact frame index
                Response_n.tStart = t  # local t and not account for scr refresh
                Response_n.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(Response_n, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'Response_n.started')
                Response_n.status = STARTED
                # keyboard checking is just starting
                waitOnFlip = True
                win.callOnFlip(Response_n.clock.reset)  # t=0 on next screen flip
                win.callOnFlip(Response_n.clearEvents, eventType='keyboard')  # clear events on next screen flip
            if Response_n.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > Response_n.tStartRefresh + 1.5-frameTolerance:
                    # keep track of stop time/frame for later
                    Response_n.tStop = t  # not accounting for scr refresh
                    Response_n.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'Response_n.stopped')
                    Response_n.status = FINISHED
            if Response_n.status == STARTED and not waitOnFlip:
                theseKeys = Response_n.getKeys(keyList=['1','2'], waitRelease=False)
                _Response_n_allKeys.extend(theseKeys)
                if len(_Response_n_allKeys):
                    Response_n.keys = _Response_n_allKeys[-1].name  # just the last key pressed
                    Response_n.rt = _Response_n_allKeys[-1].rt
                    # a response ends the routine
                    continueRoutine = False
            # Run 'Each Frame' code from code_5
            resp_n = Response_n.getKeys(['1', '2'], waitRelease=False, clear=False)
        ...
        for thisComponent in stim_neutralComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        # check responses
        if Response_n.keys in ['', [], None]:  # No response was made
            Response_n.keys = None
        neutral.addData('Response_n.keys',Response_n.keys)
        if Response_n.keys != None:  # we had a response
            neutral.addData('Response_n.rt', Response_n.rt)
        ...
        routineForceEnded = False
        # update component parameters for each repeat
        stim_image_n1_2.setColor([1,1,1], colorSpace='rgb')
        stim_image_n1_2.setOpacity(None)
        stim_image_n1_2.setContrast(None)
        stim_image_n1_2.setPos((X_n1, Y_n1))
        stim_image_n1_2.setImage(image_n1)
        stim_image_n2_2.setColor([1,1,1], colorSpace='rgb')
        stim_image_n2_2.setOpacity(None)
        stim_image_n2_2.setContrast(None)
        stim_image_n2_2.setPos((X_n2, Y_n2))
        stim_image_n2_2.setImage(image_n2)
        # keep track of which components have finished
        feedback_neutralComponents = [text_14, stim_image_n1_2, stim_image_n2_2]
        ...
        while continueRoutine and routineTimer.getTime() < 4.0:
            ...
            if text_14.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > text_14.tStartRefresh + 4.0-frameTolerance:
                    # keep track of stop time/frame for later
            ...
            # *stim_image_n1_2* updates
            if stim_image_n1_2.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                # keep track of start time/frame for later
                stim_image_n1_2.frameNStart = frameN  # exact frame index
                stim_image_n1_2.tStart = t  # local t and not account for scr refresh
                stim_image_n1_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(stim_image_n1_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'stim_image_n1_2.started')
                stim_image_n1_2.setAutoDraw(True)
            if stim_image_n1_2.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > stim_image_n1_2.tStartRefresh + 4.0-frameTolerance:
                    # keep track of stop time/frame for later
                    stim_image_n1_2.tStop = t  # not accounting for scr refresh
                    stim_image_n1_2.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'stim_image_n1_2.stopped')
                    stim_image_n1_2.setAutoDraw(False)
            
            # *stim_image_n2_2* updates
            if stim_image_n2_2.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                # keep track of start time/frame for later
                stim_image_n2_2.frameNStart = frameN  # exact frame index
                stim_image_n2_2.tStart = t  # local t and not account for scr refresh
                stim_image_n2_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(stim_image_n2_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'stim_image_n2_2.started')
                stim_image_n2_2.setAutoDraw(True)
            if stim_image_n2_2.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > stim_image_n2_2.tStartRefresh + 4.0-frameTolerance:
                    # keep track of stop time/frame for later
                    stim_image_n2_2.tStop = t  # not accounting for scr refresh
                    stim_image_n2_2.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'stim_image_n2_2.stopped')
                    stim_image_n2_2.setAutoDraw(False)
            # Run 'Each Frame' code from code_6
            stim_image_n1_2.setContrast(contrast1)
            stim_image_n2_2.setContrast(contrast2)
            ...
            #if participant choses image 1 (according to its position)
            if resp_n == '1' and X_n1 == -0.3 and Y_n1 == 0.3:
                contrast1 = -0.5
                contrast2 = 1.0
            elif resp_n == '2' and X_n1 == -0.3 and Y_n1 == -0.3:
                contrast1 = -0.5
                contrast2 = 1.0
            elif resp_n == '3' and X_n1 == 0.3 and Y_n1 == 0.3:
                contrast1 = -0.5
                contrast2 = 1.0
            elif resp_n == '4' and X_n1 == 0.3 and Y_n1 == -0.3:
                contrast1 = -0.5
                contrast2 = 1.0
            #if participant choses image 2 (according to its position)
            elif resp_n == '1' and X_n2 == -0.3 and Y_n2 == 0.3:
                contrast1 = 1.0
                contrast2 = -0.5
            elif resp_n == '2' and X_n2 == -0.3 and Y_n2 == -0.3:
                contrast1 = -0.5
                contrast2 = 1.0
            elif resp_n == '3' and X_n2 == 0.3 and Y_n2 == 0.3:
                contrast1 = -0.5
                contrast2 = 1.0
            elif resp_n == '4' and X_n2 == 0.3 and Y_n2 == -0.3:
                contrast1 = -0.5
                contrast2 = 1.0
            else:
                contrast1 = 1.0
        ...
        # update component parameters for each repeat
        # keep track of which components have finished
        reward_neutralComponents = [fix_reward_n]
